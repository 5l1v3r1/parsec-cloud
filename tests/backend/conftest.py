...
@pytest.fixture
def apiv2_backend_sock_factory(backend_raw_transport_factory, coolorg):
...
@pytest.fixture
async def alice_backend_sock(apiv2_backend_sock_factory, backend, alice):
    async with apiv2_backend_sock_factory(backend, alice) as sock:
        yield sock


@pytest.fixture
async def alice2_backend_sock(apiv2_backend_sock_factory, backend, alice2):
    async with apiv2_backend_sock_factory(backend, alice2) as sock:
        yield sock


@pytest.fixture
async def otheralice_backend_sock(apiv2_backend_sock_factory, backend, otheralice):
    async with apiv2_backend_sock_factory(backend, otheralice) as sock:
        yield sock


@pytest.fixture
async def adam_backend_sock(apiv2_backend_sock_factory, backend, adam):
    async with apiv2_backend_sock_factory(backend, adam) as sock:
        yield sock


@pytest.fixture
async def bob_backend_sock(apiv2_backend_sock_factory, backend, bob):
    async with apiv2_backend_sock_factory(backend, bob) as sock:
        yield sock
